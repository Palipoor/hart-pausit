...
from .modeling_hart import HaRTBasePreTrainedModel, HaRTBaseLMHeadModel
from .modeling_outputs import HaRTOutput
...
class HaRTPreTrainedModel(HaRTBasePreTrainedModel):
    ...
    def forward(
        ...
        for i in range(blocks_len):
            ...
            extract_layer_hs = arhulm_output["extract_layer_hidden_states"][0] if isinstance(arhulm_output, dict) else \
            arhulm_output[-1][0]
